...
| "and/or monitoring solution, and/or prime-owned msig"; "Additional Sentinel addresses are optional and recommended" | C7 | Read as an exhaustive list of who may hold a seat: the curator address, the curator Safe's signers and the external curator may not be sentinels (FAIL, adopted 2026-09-08). Extra seats must be Prime-owned or a monitoring solution; an unattributed extra is WARN until a public label says what it is. | Open question 4: confirm the exhaustive reading; a permissive reading of "additional sentinel addresses" would allow any extra address. |
