...
| C2 | Loan asset | address allow-list per chain (below) | FAIL | Policy section 'Loan assets': per Atlas cash stablecoins USDC, USDT, pyUSD; also historically approved for Morpho: RLUSD, USDG. Any other loan asset: risk review + separate request. |
